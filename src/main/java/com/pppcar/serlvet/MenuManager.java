...
import com.pppcar.pojo.Button;
import com.pppcar.pojo.CommonButton;
import com.pppcar.pojo.ComplexButton;
import com.pppcar.pojo.Menu;
import com.pppcar.pojo.ViewButton;
import com.pppcar.util.HttpRequestUtil;
	...
	public class MenuManager {
		...
		public static void main(String[] args) {
			...
			if (null != at) {
				// 调用接口创建菜单
				int result = HttpRequestUtil.createMenu(getMenu(), at.getToken());
		...
		private static Menu getMenu() {
			...
			btn13.setName("趴趴派客");
			btn13.setType("view");
			btn13.setUrl("http://www.pppcar.com");
